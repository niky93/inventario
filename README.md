...
2. En [Cloudflare Pages](https://dash.cloudflare.com/), elige `Create application` y conecta el repositorio.
3. Usa `main` como rama de produccion.
4. Deja vacio el comando de compilacion y usa `/` como directorio de salida.
5. Abre la direccion `*.pages.dev` que Cloudflare mostrara al terminar.
